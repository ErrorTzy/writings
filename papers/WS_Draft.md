...
Recall Bennett's account about building: a building relation has to be *directed*, *necessitating* and *generative*. The problem here is generative requirement. According to Bennett, the generative requirement is that,
...
The proof is as follows: Rational agency requies de se attitude. De se attitudes requires the *adoption* of first person pronouns 'I' (or other syntactic equivalence). Therefore, rational agency requires us to read reality off the first person pronoun and adopt the existence of "I". 
...
I want to first use this to establish a positive account of causation, and then extend it to fundamentality. But let me clarify things a bit before I begin.
