...
Where does the subjectivity of the Mona Lisa's beauty come from? Assume we stipulate that *"beautiful"* precisely means *painted by Da Vinci*. Then the Mona Lisa is objectively beautiful, because it was objectively painted by Da Vinci. Subjectivity seems to disappear once I stipulate the meaning of "beautiful."

Where did subjectivity go? People will arguably contend the following: my stipulation is entirely subjective. I believe this is right. The Mona Lisa's beauty is subjective because there are other equally good candidate meanings for "beautiful". In other words, "The Mona Lisa is a beautiful painting" is subjective because it does not determinately pick out a fact. And the indeterminacy comes from the vagueness of the meaning of "beautiful." Similarly, if one holds that utilitarianism, deontology, and virtue ethics are all reasonable positions, then one might think morality is not objective.

To generalize this line of thought, I believe the best way to capture the interesting sense of "objectivity" is as follows:
...
I need to stress that, even if we have a fully precisified language, it does not follow that everything becomes *semantically objective*, in the sense that is relevant to metaphysics. The sense of "objectivity" in metaphysics is different from "objectivity" in ordinary contexts. I put further explanation in the footnote.[^3] For example, assume the quantifier in ordinary English has only one precise meaning. It does not follow that, other possible meanings of the quantifier cannot be reasonable. Mereological nihilists' use of their quantifier is also metaphysically reasonable. Hirsch (==citation==) has extensively argued that any fact expressible in ordinary language can also be expressed in the mereological nihilists' English, and vice versa.[^1] Therefore, there is no metaphysical reason to reject mereological nihilists' language.
...
Now the problem is, what would prevent something we intend to from having alternative shape? Naturally, it would be something in the world that may ensure this. 
...
[^2]: Similarly, we may say moral facts belongs to a subjective realm, and different communities has different realms of morality. If this kind of moral relativism is right, then morality is subjective in this sense.
[^3]: In ordinary conversation, we would say the mereological nihilists' quantifier is NOT reasonable. It sounds crazy to say "there are no tables." Therefore, in ordinary contexts, it is fairly objective that there are tables. In my previous example, where I stipulate "beautiful" to mean painted by Da Vinci, I said it is intuitively objective in an ordinary context. But surely the meanings of "paint" and "Da Vinci" admit of vagueness. Does this undermine my account? I believe not. We can easily alter our intuition about objectivity by varying the context. For example, if the Mona Lisa were completely produced by chance by randomly pouring paint onto the drawing board while Da Vinci was dreamwalking, it would start to seem subjective to say that the Mona Lisa is painted by Da Vinci, because it is not clear whether the procedure that produced the Mona Lisa still counts as painting. In other words, "objectivity" in ordinary speech depends on context. This is similar to "the shape of France is a hexagon": a hexagon has a precise meaning, but it can be loosely used in ordinary speech. How loosely it can be used depends on the context. But in metaphysics, we aim at "perfect objectivity". Whatever is true is reasonable, no matter whether it departs from our conversational conventions, intuitions, or pragmatic convenience.