...
However, there are some critical issues with Hall's argument. First, what does "enhances our ability to conduct inquiry" mean, exactly? In Sections 2.1 and 5, Hall seems to treat this to mean "obvious and easy to grasp". But that is precisely what grounding claims are not about. The project of grounding is often seen as a revival of Aristotle's metaphysics. So let's go back to Aristotle:
