...
I personally stand with Hirsch on this matter. For me, to say that I meant something is, first and foremost, to say that I am in a mental state that is about something. It just seems absurd to say that I cannot control what I mean, and that what is in my mind depends on how other people interpret it.[^13]
...
To the best of my knowledge, there are only three positions to the paradox: first, that meaning comes from facts of irreducible intentionality; second, that meaning comes from facts about dispositions; and third, that there is no fact of the matter about whether we mean anything.
...
[^13]: I am fully aware of the sense in which meaning cannot be controlled by me. To use the classical example, I might use "the man drinking a martini" to refer to a man drinking a champagne. In that case, though I intend to mean the man drinking a champagne, these words still mean the man drinking a martini. However, I believe this sense of meaning is simply irrelevant to the current issue. An ontological debate between $X$ and $Y$ is a debate between how $X$ take the world to be, and how $Y$ take the world to be. How $X$ take the world to be can only be revealed by looking at what $X$ *actually* intend to express, not what $X$'s utterance *should* express.