...
In philosophy, when people disagree with each other, they are probably also disagreeing about the meanings of words. For example, when Kantians and utilitarians disagree about what is right or wrong, they also define these terms differently so that they are at the same time disagreeing about the meanings of "right" and "wrong". The harder question, however, is whether they are *merely* disagreeing about words, or whether there is something deeper in the dispute.
...
Hirsch proposes that the same sort of reasoning applies here. We should not interpret van Inwagen and Lewis in a way that saddles one or both of them with an obvious a priori mistake about whether tables exist (they obviously do!). Instead, we should interpret them as speaking different languages that deviate from standard English. So each of which makes their claims come out true on their own terms.
...
The crucial point is that each party takes $D$ to be equivalent to different sentences. Van Inwagen holds that $D$ is equivalent to $A_{2}$. Lewis holds that $D$ is equivalent to $A_{1}$. According to interpretive charity, we should not take them to be making a priori mistakes about equivalent sentences. Instead, we should take these claims to be the semantic rules they are following.
...
The intuitive idea behind this argument is that $Y$ should translate $X$'s utterance of $D$ as expressing $A_1$, and $X$ should translate $Y$'s utterance of $D$ as expressing $A_2$. Of course, the dispute between $X$ and $Y$ is not over just one sentence, $D$, but over many others. For example, for any agreed true sentence $S$, there will also be a disagreement over $S \land D$. But as long as $X$ and $Y$ can translate any disputed sentence into some agreed sentence, they disagree only over which expressions they should use to express their agreed fact.
...
I personally stand with Hirsch on this matter. For me, to say that I meant something is, first and foremost, to say that I am in a mental state that is about something. It just seems absurd to say that I cannot control what I mean, and that what is in my mind depends on how other people interpret it.

That said, because of this divergence, I will divide my discussion into two parts. In the first part, I will argue against a phantom Hirsch who accepts that meaning does not come from interpretation. In the second part, I will argue against a phantom Warren who accepts that meaning comes from interpretation.
...
Let me grant that *Propositional supervenience* is valid. In our previous argument, $Y$ stipulated $L^{Y}(A_{1})=L_{X}(A_{1})$. Now assume $L_{X}$ and $L^{X}$ are *truth-conditionally indiscernible*, by *Propositional supervenience* we must also have $L^{X}(A_{1})=L_X(A_{1})$. Therefore, we must have $L^{X}(A_{1})=L^Y(A_{1})$.
...
To the best of my knowledge, there are only three positions to the paradox: first, that meaning comes from facts of irreducible intentionality; second, that meaning comes from facts about dispositions; and third, that there is no fact of the matter about whether we mean anything.[^13]

There are tons of literature on the third option, so it may require careful treatment. Here, however, I set it aside without too much argument. One reason is that an ontological dispute is, at least, a dispute about whether certain facts obtain. But, following @wrightKripkesAccountArgument1984, if we adopt the third option, then we must "abandon the idea that it is *ever* the case that language has a fact-stating function". Thus, the third option simply makes the very idea of ontological dispute vanish into thin air. A second reason is that the position is simply so counterintuitive that I doubt many philosophers genuinely accept it.
...
One of Kripke’s objections can be stated roughly as follows: We can make mistakes and fail to use words in accordance with what we mean. Dispositionalism, however, seems unable to distinguish such mistakes from correct applications of the rules that govern meaning.

In response, Warren argues that the correct application of a rule of meaning can be identified in the following way: for a given class of situation $C$, the correct application is determined by the disposition that yields a *stable* answer in the *overwhelming majority* of specific situations in $C$, provided that the speaker’s general cognitive functioning is not *interfered with*.
...
To fit Warren’s criterion more precisely, we can add a fictional detail to the actual clinical report. When Warren adds the condition that the speaker’s general cognitive functioning is not *interfered with*, he seems to be excluding anomalies such as drug influence, fatigue, and similar disruptions. But suppose, instead, that the patient’s aphasia was not caused by accidental brain damage. Rather, the patient has an unusual genetic condition: he possessed linguistic capacities in childhood, but over the course of development his brain naturally came to exhibit aphasic patterns of functioning. Since aphasia has characterized most of his cognitive life, it seems to count as part of his normal cognitive functioning rather than as an abnormal disruption of an otherwise intact capacity. Suppose further that, when producing meaningless speech, he consistently produces just one meaningless sound. Given this setup, Warren’s criterion implies that the correct behavior, the one that determines what the patient means, is the production of meaningless speech, despite the patient’s "frustrated and agitated behaviour" and his attempts to overcome the problem.

Even putting aside all these issues, I believe taking *interpretive charity* as a metaphysical principle of meaning is off the track right from the start. Earlier, I said, it just seems absurd to say that I cannot control what I mean, and that what is in my mind depends on how other people interpret it. But I am fully aware of the sense in which meaning cannot be controlled by me. To use the classical example, I might use "the man drinking a martini" to refer to a man drinking a champagne. In that case, though I intend to mean the man drinking a champagne, these words still mean the man drinking a martini. In other words, except from "what I intend to mean", there is indeed a sense of "meaning" that means "what I should have meant, given what I said". However, I believe this second sense of "meaning" is simply irrelevant to the current issue. An ontological debate between $X$ and $Y$ is a debate between how $X$ take the world to be, and how $Y$ take the world to be. How $X$ take the world to be can only be revealed by looking at what $X$ *actually* intend to express, not what $X$'s utterance *should* express.

## What is a verbal dispute, then?

All I have shown so far may be summarized as follows: if one wants to accept Hirsch’s deflationism, either (1) one accepts interpretive charity as a pragamatic principle of meaning and assume Hirsch’s "lightweight" ontological view, which amounts to presuppose Hirsch’s conclusion, or (2) one accepts interpretive charity as a metaphysical principle of meaning and accept the problematic view of dispositionalism. Since I have a strong inclination to reject dispositionalism, I believe (1) might be the only option left.
...
In this example, I agree with James that this is a mere verbal dispute. I come to this conclusion by first imagine what the situation is *in fact* like, and only then ask how the situation should be described *in words*. Then I realize the very same imagination can be described in different ways: for example, you can describe it in English, in Latin, or in Greek. When James diagnosed that once the linguistic issue is settled "there is no occasion for any farther dispute", he seemed to mean that we agree on the question "What is this situation *in fact* like?", while disagreeing on the question "How should this be described *in words*?"

The key point is that, in the first step, we need to picture the movements of the man and the squirrel in order to understand the case. This act of picturing is very close to  imaginatively constructing a *perceptual content*. My intuition here comes from naive realism about perception: if anything gives us direct access to the external world, perception does. Even most representationalists would also accept that perceptual experience is transparent. Of course, this intuition faces familiar problems, such as hallucination and illusion. Since I am reaching the word limit, however, I have to settle these problems and give a full account of my view elsewhere. Here, my aim is only to preserve the basic intuition that, in perception, what we see is simply how the world is like. If the world need not be isomorphic to our perceptual content, then it becomes unclear what could count as misrepresenting the world at all. For example, in a case of hallucination, if there is no such isomorphism requirement, why not say that we are veridically perceiving the neurons firing in our brain?

For this reason, I do not want to accept the lightweight view according to which the world is just a large, fat, unstructured chunk, and any structure imposed on it is merely a consequence of our conceptual scheme. It seems more commonsensical to think that the external world is structured in ways that correspond to the structure of our perceptual content. Hirsch often presents himself as a common-sense philosopher, and I think this is the more plausible position for him to take.

Let me conclude by briefly stating some consequences of my position I have sketched above. I believe that meaning arises from irreducible intentionality, and I also believe in a heavyweight metaphysics whose weight comes from perceptual experience. Unfortunately, both intentionality and perceptual experience are private and not directly demonstrable to others. In that sense, I think ontological disputes are ultimately irresolvable, because I cannot really know what your perceptual experience is like or what you truly intend to express. Even so, I do not reject interpretive charity as a pragmatic principle. On that basis, we may treat some disagreements as merely verbal for practical purposes and move on with our lives.
...
[^6]: This footnote is prepared for those who hate symbols: I tried to formulate the argument without symbols, but eventually I found it necessary to use them. Without them, my sentences will become incredibly long and ambiguous. I apologize for the inconvenience, but I beg you to accept the symbols.
...
[^13]: Some may suggest *interpretationism* being a fourth option, i.e. meaning comes from the interpretation of one's utterance. But what is an *interpretation*, if it is neither an intentional state, nor facts about disposition?