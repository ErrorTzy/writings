...
In this paper, I first summarize the current researches on the common factors that affect memory. Then I \dots. I close this paper by \dots. I wish to show that \dots.
...
Sleep also enhance memory. The process is called \textit{consolidation}. Research has shown that both SWS and REM contributes to solidifying knowledge learnt in day \autocite{diekelmannMemoryFunctionSleep2010}.

\section{About Jazz}

Jazz's roots can be traced back to the African musical heritage and its fusion with European musical forms in the New World, leading to the creation of work songs, spirituals, ragtime, and the blues. This unique blend gave birth to jazz in New Orleans, where it was further developed and popularized by pioneers like Louis Armstrong, Duke Ellington, and Billie Holiday, among others. The city's vibrant music scene, characterized by a mix of cultures, played a crucial role in the genre's formation, with musicians from black, white, and Creole backgrounds contributing to its rich diversity \autocite{gioiaHistoryJazz1998,stearnsStoryJazz1956}.

Jazz has undergone several transformations, from the early sounds of New Orleans jazz and Chicago jazz in the 1920s and 1930s to the development of swing, bebop, cool jazz, and hard bop. Each style represented not only a musical evolution but also mirrored the social and cultural changes of its time. The migration of jazz musicians from New Orleans to cities like Chicago and New York contributed to the genre's spread and the emergence of new styles. Icons such as Charlie Parker, Dizzy Gillespie, Thelonious Monk, and Miles Davis were instrumental in these transitions, pushing the boundaries of jazz and exploring new harmonic and rhythmic possibilities \autocite{schullerEarlyJazzIts1986}.

\subsection{Swing Rhythm}

Swing rhythm in jazz is a distinctive musical style that creates a compelling sense of rhythm and movement, often making listeners want to dance or move along with the music. The essence of swing rhythm lies in the way certain notes are played longer and others are played shorter, contrary to their equal written value, creating a long-short pattern within a beat. As illustrated in Figure \ref{notes}, \ref{noteA} illustrates the normal rhythm, namely the straight rhythm. \ref{noteB} shows the swing rhythm by grouping two notes into a triplet with a rest in between. The effect of swing rhythm would be close to \ref{noteC}. 
...
Another key feature of jazz is called ``call and response''. It is a kind of musical interaction where one musician plays a phrase (the ``call'') and another musician or group responds with a complementary phrase (the ``response'').

Jazz musicians engage in call and response interactions by anticipating and responding to each other's musical phrases, creating a spontaneous collaboration even when playing together for the first time. This interaction is evident in both the movement and musical characteristics of improvisations, reflecting the emotions expressed by the musicians. Studies have found correlations between the movements and musical features of jazz duos during improvisation, highlighting the deep connection between physical expression and musical communication \autocite{wollnerCallResponseMusical2020}.
