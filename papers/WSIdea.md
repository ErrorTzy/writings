...
While this paper is motivated by a question in (meta)metaphysics, what I want to defend goes beyond it. At a very high level, the paper grapples with a central tension. On one hand, it seems all possible philosophical conclusion must ultimately rely on intuitive premises. If so, then we cannot establish anything if we throw away all of our intuitions (or dispositions, sentiments, whatever). On the other hand, many of our intuitions seem shaky, unreliable or contingent. The problem, then, is to figure out which part of our intuition cannot (or at least, should not) be thrown away. 

I frist argue this tension indeed exists in (meta)metaphysics. This tension has been implicitly pointed out by a form of neo-Quinean argument, but somehow they still get ignored. Then I argue for a principle that basically says we cannot throw away our rational agency. And I spend the rest of the paper exploring what follows from it. Mostly, I use it to defend an interventionist approach to fundamentality, but I also included some consequences beyond metaphysics.

The starting point of this paper comes from the following question: How much reality should we read off our language? This is central to maybe all metaphysical problems. For example, almost all natural languages have a subject-predicate structure. Should we then say, the world itself is constituted of objects and properties? Grammatically we have predicates like 'good' or 'bad'. Then should we read them off our language and say there are such properties in the world? Also, the proposition $P$ may seem syntactically more primitive than $\neg \neg P$. Should we read this structure off our language and say the *fact* that $P$ is in some sense more fundamental than the *fact* that $\neg \neg P$? Quantum physics describes the world in terms of wave functions. Should we then interpret that reality as just a bunch of waves (or maybe, a huge, holistic wave)?
...
The reason I frame the question in this way is because normally, the standard story in metametaphysics is told differently. As we will see in a moment, the standard story seems to be ignoring something important. The standard story goes like this: 
