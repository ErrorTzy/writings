...
While this paper is motivated by a question in (meta)metaphysics, what I want to defend goes beyond it. At a very high level, the paper grapples with a central tension. On one hand, it seems all possible philosophical conclusion must ultimately rely on intuitive premises. If so, then we cannot establish anything if we throw away all of our intuitions (or dispositions, sentiments, whatever). On the other hand, many of our intuitions seem shaky, unreliable or contingent. The problem, then, is to figure out which part of our intuition cannot be thrown away. 

I frist argue that there exists such a tension in metametaphysics. This tension has been implicitly pointed out by a form of neo-Quinean argument, but somehow they still get ignored. Then I argue for a principle that basically says we cannot throw away our rational agency. And I spend the rest of the paper exploring what follows from it, including some consequences beyond metaphysics.
