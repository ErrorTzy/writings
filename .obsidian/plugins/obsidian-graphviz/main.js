      ...
      this.app.workspace.onLayoutReady(() => {
        switch (this.settings.renderer) {
          case "d3_graphviz":
            ...
            this.registerMarkdownCodeBlockProcessor("graphviz", processors.d3graphvizProcessor.bind(processors));
            break;
          default:
            this.registerMarkdownCodeBlockProcessor("graphviz", processors.imageProcessor.bind(processors));
        }
      });
    });
  }
