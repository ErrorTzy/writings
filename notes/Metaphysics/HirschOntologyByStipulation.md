...
>  
> Now the problem is what exactly did Hirsch mean by "truth-condition". We must revisit Hirsch's argument to examine this. According to hirsch's argument, the stipulation is that, U has the same truth condition in S-Lewis and L, and it is stipulated that C has the same truth condition in S-Lewis as U in S-Lewis. For S-Lewis and L to be truth conditionally indiscernible, hirsch must say if nec(P iff Q) then P and Q to have the same truth condition. Now, we have stipulated the following to be true: it is necessary that "H=H" in Devi-L and "H=H" in our language.
> 
